 ...
 <footer class="footer mt-auto py-4">
        <div class="container text-center">
            ...
            <div class="d-flex justify-content-center gap-3 mb-2">
                ...
                <a href="<?= BASE_URL ?>Pages/sobre_nos.php" class="footer-link">Sobre</a>
            ...
            <a href="https://instagram.com" target="_blank" class="footer-icon"><i class="fa-brands fa-instagram"></i></a>
<a href="https://wa.me" target="_blank" class="footer-icon"><i class="fa-brands fa-whatsapp"></i></a>
<a href="mailto:" class="footer-icon"><i class="fa-solid fa-envelope"></i></a>
            </div>
            <!-- Copyright -->
